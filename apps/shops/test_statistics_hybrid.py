...
from apps.vendor.boutique.models import Shops, ShopStatistics
from comptes.models import SellerAccount
from commandes.models import Orders, LigneCommande
from apps.vendor.produits.models import Products, Categories
...
class CeleryTasksTestCase(TestCase):
    ...
    def test_recalculate_daily_shop_statistics_task(self):
        ...
        """
        try:
            from apps.vendor.boutique.tasks import recalculate_daily_shop_statistics
