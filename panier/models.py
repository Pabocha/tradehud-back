...
from produits.models import Products  # ou ton modèle de produit
from djmoney.models.fields import MoneyField

class CartItem(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    variant = models.ForeignKey('produits.ProductVariant', on_delete=models.PROTECT, null=True, blank=True)
